"""
Django settings for petpal_marketplace_45516 project.
...
ROOT_URLCONF = 'petpal_marketplace_45516.urls'
...
WSGI_APPLICATION = 'petpal_marketplace_45516.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "petpal_marketplace_45516 API",
    "DESCRIPTION": "API documentation for petpal_marketplace_45516 App",
    "VERSION": "v1",
}
